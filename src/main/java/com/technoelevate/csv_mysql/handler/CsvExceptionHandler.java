package com.technoelevate.csv_mysql.handler;
...
import com.technoelevate.csv_mysql.response.ErrorMessage;
...
public class CsvExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<ErrorMessage> invalidWordException(CsvException exception, WebRequest request) {
